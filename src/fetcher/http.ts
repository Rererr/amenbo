...
export const USER_AGENT = "amenbo/0.6 (+https://github.com/Rererr/amenbo)";
...
const IPV6_RESERVED_RANGES: Array<[string, number]> = [
  ...
  // 2001::/23(IETFプロトコル割当)を一括で塞ぐと、その中にあるGlobally Reachableな
  // エニーキャスト(PCP 2001:1::1、AMT 2001:3::/32等)まで巻き込むため、
  // 到達性が無い/塞ぐべき小範囲だけを個別に挙げる。
  ["2001::", 32], // Teredo(IPv4をトンネルする)
  ["2001:2::", 48], // ベンチマーク
  ["2001:10::", 28], // ORCHID(廃止済み)
  ["2001:db8::", 32], // ドキュメント用
